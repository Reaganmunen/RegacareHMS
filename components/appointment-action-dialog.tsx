...
const AppointmentActionDialog = ({type, id, disabled}:ActionProps) => {
    ...
    <Dialog>
        <DialogTrigger asChild disabled={!disabled}>
            {type === "approve"?(
                ...
                <Button size="sm" variant="outline" className="w-full flex items-center gap-2 rounded-full text-red-500 disabled:cursor-not-allowed">
                    <Ban size={16}/>Cancel
                </Button>
            )}
        ...
        <DialogContent>
            <div className="flex flex-col items-center justify-center py-6">
                ...
                <p className="text-sm text-center text-gray-500">
                    {type ==="approve"
                    ? "you are about to confirm this appointment. Yes to Approve No to Cancel"
                ...
                <div className="flex justify-center mt-6 items-center gap-x-4">
                    ...
                    variant="outline"
                    className={cn("px-4 py-2 text-sm font-medium text-white hover:text-white hover:underline",
                        type === "approve"
