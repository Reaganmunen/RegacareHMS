        ...
        return <Dialog>
            ...
            <DialogContent>
                <div className="flex flex-col items-center justify-center py-6">
                    ...
                    <p className="text-sm">are you sure you want to delete the selected account?</p>
                    <div className="flex justify-center mt-6 items-center gap-x-3">
                        <DialogClose asChild>
                            <Button variant="outline"
                            className="px-4 py-2">Cancel</Button>
                        </DialogClose>
                        <Button
                        disabled={loading} variant="outline"
                        className="px-4 py-2 text-sm font-medium bg-destructive text-white hover:bg-destructive"
        ...
        return<Dialog>
            <DialogTrigger asChild>
                <Button variant={"outline"} className="flex items-center justify-center
                 rounded-full text-blue-500/10 hover:underline">
                 View
                </Button>
            </DialogTrigger>
