...
const Appointments = async (props: {
    ...
    const page = (searchParams?.p as string) || "1";
        ...
        >
            <td className="flex items-center gap-2 md:gap-4 py-2 xl:py-4">
                <ProfileImage
                    ...
                    name= {patient_name}
                    colorCode ={item?.patient?.colorCode ?? undefined}
                    ...
                    <div>
                        ...
                        <span className="text-xs md:text-sm capitalize">{item?.patient?.gender.toLowerCase()}</span>
                    </div>
            ...
            <td className="hidden items-center py-2 md:table-cell">
                <div className="flex items-center gap-2 md:gap-4">
                    <ProfileImage
                         ...
                         colorCode= {item.doctor?.colorCode ?? undefined}
                         //will add bgcolor later
                         />
                
                <div>
                    <h3 className="font-semibold uppercase">{item.doctor?.name}</h3>
                    <span className="text-xs md:text-sm capitalize">{item.doctor?.specialization}</span>
                </div>
                </div>
            </td>
