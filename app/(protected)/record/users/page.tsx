    ...
    (
      <tr
         ...
         className="border-b border-gray-200 even:bg-slate-50 text-base hover:bg-slate-50">
            ...
            <td className="table-cell py-2 xl:py-4">{item?.firstName} {item?.lastName}</td>
            <td className="table-cell">{item?.emailAddresses[0].emailAddress}</td>
             ...
             <td className="hidden md:table-cell capitalize">{format(item?.lastSignInAt, "yyyy-MM-dd h:mm:ss")}</td>
