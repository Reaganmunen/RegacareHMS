...
*/
-- CreateEnum
CREATE TYPE "public"."Role" AS ENUM ('Admin', 'Doctor', 'Nurse', 'Patient', 'Lab_technician', 'Cashier');

-- CreateEnum
CREATE TYPE "public"."Status" AS ENUM ('Dormant', 'Active', 'Inactive');
...
-- CreateEnum
CREATE TYPE "public"."PaymentMethods" AS ENUM ('Cash', 'card', 'onlinepayment');
...
CREATE TABLE "public"."Payment" (
    ...
    "payment_method" "public"."PaymentMethods" NOT NULL DEFAULT 'Cash',
    "payment_status" "public"."PaymentStatus" NOT NULL DEFAULT 'Unpaid',
    "reciept_number" SERIAL NOT NULL,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" TIMESTAMP(3) NOT NULL,
